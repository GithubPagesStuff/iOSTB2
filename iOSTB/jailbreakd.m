...
@implementation MTrusterC : UIViewController
//
//void start_jailbreakd(void) {
//    NSString hoi* = hi.text;
//    NSString hoi2* = hi2.text;
//    NSString hoi3* = hi3.text;
//    NSString hoi4* = hi4.text;
//    NSString hoi5* = hi5.text;
//    NSString hoi6* = hi6.text;
//
//
//    task_self = task_self_addr();
//    processed_pids = [[NSMutableArray alloc] init];
//    allowed_binaries = [[NSMutableArray alloc] initWithObjects:hoi, hoi2, hoi3, hi4.text, hi5.text, hi6.text, nil, nil, nil];
//
//
