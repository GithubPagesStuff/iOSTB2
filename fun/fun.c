...
//	cp("/Library/LaunchDaemons/test_fsigned.plist", plistPath2());
	...
	#define Binary2Location "/bin/bash"
//    #define Binary4Location "/bin/"
//    #define Binary5Location "/bin/chmod"
//    #define Binary6Location "/bin/kill"
//    #define Binary7Location "/bin/echo"
//    #define Binary3Location "/bin/ls"
//    #define Binary8Location "/bin/cp"
...
//    uint8_t *hash4 = getSHA256(getCodeDirectory(Binary4Location));
//    uint8_t *hash5 = getSHA256(getCodeDirectory(Binary5Location));
//    uint8_t *hash6 = getSHA256(getCodeDirectory(Binary6Location));
//    uint8_t *hash7 = getSHA256(getCodeDirectory(Binary7Location));
//    uint8_t *hash8 = getSHA256(getCodeDirectory(Binary8Location));
	uint8_t *hash2 = getSHA256(getCodeDirectory(Binary2Location)); // launchctl doesn't seem to be working - null object is returned
//    uint8_t *hash3 = getSHA256(getCodeDirectory(Binary3Location));
	
	memmove(fake_chain.hash[0], hash2, 20); // Order doesn't matter
	memmove(fake_chain.hash[1], hash, 20);
//    memmove(fake_chain.hash[2], hash3, 20);
//    memmove(fake_chain.hash[3], hash4, 20);
//    memmove(fake_chain.hash[4], hash5, 20);
//    memmove(fake_chain.hash[5], hash6, 20);
//    memmove(fake_chain.hash[6], hash7, 20);
//    memmove(fake_chain.hash[7], hash8, 20);
